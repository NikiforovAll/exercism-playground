...
{
    private static class ProteinsAlphabet
    {
        public const string Methionine = "Methionine";
        public const string Phenylalanine = "Phenylalanine";
        public const string Tryptophan = "Tryptophan";
        public const string Cysteine = "Cysteine";
        public const string Tyrosine = "Tyrosine";
        public const string Serine = "Serine";
        public const string Leucine = "Leucine";
    ...
    {
        return strand.Batch(3, b => new string(b.ToArray()))
            .Select(tripplet => tripplet switch
            {
                "AUG" => ProteinsAlphabet.Methionine,
                "UGG" => ProteinsAlphabet.Tryptophan,
                _ when CheckGroup(tripplet, "UUU", "UUC")
                    => ProteinsAlphabet.Phenylalanine,
                _ when CheckGroup(tripplet, "UUA", "UUG")
                    => ProteinsAlphabet.Leucine,
                _ when CheckGroup(tripplet, "UCU", "UCC", "UCA", "UCG")
                    => ProteinsAlphabet.Serine,
                _ when CheckGroup(tripplet, "UAU", "UAC")
                    => ProteinsAlphabet.Tyrosine,
                _ when CheckGroup(tripplet, "UGU", "UGC")
                    => ProteinsAlphabet.Cysteine,
                _ => ProteinsAlphabet.STOP,
            }).TakeWhile(i => ProteinsAlphabet.STOP != i)
            .ToArray();
        static bool CheckGroup(string item, params string[] group) =>
            new HashSet<string>(group).Contains(item);
    }
}
